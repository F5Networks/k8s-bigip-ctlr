...
func (in *AS3Status) DeepCopyInto(out *AS3Status) {
	*out = *in
	in.LastSubmitted.DeepCopyInto(&out.LastSubmitted)
...
func (in *AS3Status) DeepCopy() *AS3Status {
	if in == nil {
		return nil
	}
	out := new(AS3Status)
...
func (in *BigIPStatus) DeepCopyInto(out *BigIPStatus) {
	*out = *in
	if in.L3Status != nil {
		in, out := &in.L3Status, &out.L3Status
		*out = new(L3Status)
		(*in).DeepCopyInto(*out)
	}
	if in.AS3Status != nil {
		in, out := &in.AS3Status, &out.AS3Status
		*out = new(AS3Status)
		(*in).DeepCopyInto(*out)
	}
	return
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CMStatus) DeepCopyInto(out *CMStatus) {
	*out = *in
...
func (in *CMStatus) DeepCopy() *CMStatus {
	if in == nil {
		return nil
	}
	out := new(CMStatus)
...
func (in *DeployConfigStatus) DeepCopyInto(out *DeployConfigStatus) {
	*out = *in
	...
	if in.CMStatus != nil {
		in, out := &in.CMStatus, &out.CMStatus
		*out = new(CMStatus)
		(*in).DeepCopyInto(*out)
	}
	if in.NetworkConfigStatus != nil {
		in, out := &in.NetworkConfigStatus, &out.NetworkConfigStatus
		*out = new(NetworkConfigStatus)
		(*in).DeepCopyInto(*out)
	}
	if in.BigIPStatus != nil {
		in, out := &in.BigIPStatus, &out.BigIPStatus
		*out = make([]BigIPStatus, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.K8SClusterStatus != nil {
		in, out := &in.K8SClusterStatus, &out.K8SClusterStatus
		*out = make([]K8SClusterStatus, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *L3Status) DeepCopyInto(out *L3Status) {
	*out = *in
	in.LastSubmitted.DeepCopyInto(&out.LastSubmitted)
	in.LastSuccessful.DeepCopyInto(&out.LastSuccessful)
	return
...
func (in *L3Status) DeepCopy() *L3Status {
	if in == nil {
		return nil
	}
	out := new(L3Status)
