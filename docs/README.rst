...
- You can `configure an IPAM system <http://clouddocs.f5.com/containers/v1/kubernetes/kctlr-manage-bigip-objects.html#use-ipam-to-assign-ip-addresses-to-big-ip-ltm-virtual-servers>`_ to write out an annotation containing the selected IP address.
