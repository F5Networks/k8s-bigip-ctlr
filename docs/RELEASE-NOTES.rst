...
**What's new:**
    ...
    * CRD
        ...
        * `Issue 3418 <https://github.com/F5Networks/k8s-bigip-ctlr/issues/3418>`_: Support for bigip route domain for virtual addresses in Virtual Server, Transport Server, and Ingress. See examples with `virtual server <config_examples/customResource/VirtualServer/virtual-with-ipamLabel-bigipRouteDomain>`_, `transport server <config_examples/customResource/Ingresslink/ingressLink-with-ipamLabel-bigipRouteDomain>`_, and `ingresslink <config_examples/customResource/VirtualServer/virtual-with-ipamLabel-bigipRouteDomain>`_.
