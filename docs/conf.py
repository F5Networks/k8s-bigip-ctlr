...
project = u'F5 Container Connector - Kubernetes'
...
# Substitutions and links to use across project docs
...
#
html_title = u'F5 Container Connector - Kubernetes'

# A shorter title for the navigation bar.  Default is the same as html_title.
#
html_short_title = u'F5 CC - Kubernetes'
...
htmlhelp_basename = 'F5_Container_Connector-Kubernetes_doc'
...
latex_documents = [
    (master_doc, 'F5_Container_Connector-Kubernetes.tex',
     u'F5_Container_Connector for Kubernetes - Documentation',
     'F5 Networks', 'manual'),
]
...
man_pages = [
    (master_doc, 'F5_Container_Connector-Kubernetes',
     u'F5_Container_Connector for Kubernetes - Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'F5_Container_Connector-Kubernetes',
     u'F5 Container Connector - Kubernetes Documentation',
     author, 'F5_Container_Connector-Kubernetes', 'manual'),
]
