...
.. _Kubernetes Daemonset: http://kubernetes.io/docs/admin/daemons/
.. _Kubernetes Deployment: http://kubernetes.io/docs/user-guide/deployments/
.. _Kubernetes Guestbook Demo: https://github.com/kubernetes/kubernetes/tree/master/examples/guestbook-go
"""
...
#
html_short_title = u'F5 CSI - Kubernetes'
