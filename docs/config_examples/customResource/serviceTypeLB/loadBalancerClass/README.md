...
| Deployment Parameter            | Type    | Required | Default Value | Description                                                                                                                                                                                                                                                                | Allowed Value | Agent | Minimum supported version |
|---------------------------------|---------|----------|---------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------|-------|---------------------------|
...
| manage-load-balancer-class-only | Boolean | Optional | false         | If set to true, CIS processes all load balancer services with loadBalancerClass only. <br> If set to false, CIS process all the load balancer service without loadBalancerClass and service that have the loadBalancerClass specified by the load-balancer-class parameter | true, false   | AS3   | 2.18.0                    |
