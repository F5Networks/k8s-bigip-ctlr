...
Refer to the [Release Notes](./RELEASE-NOTES.rst) for additional information.
...
|v2.20.2     | v17.0           | v1.33              | v4.18.0*                                                      | Yes | Yes                | v3.55       | v0.1.12    | v0.0.5            | v0.0.35           | Red Hat Enterprise Linux release 9.1 (Plow)         |
...
| v2.20.2     | v17.0          | v1.33              | v4.18.0*          | Yes      | No  | Yes                | v3.55       | v0.0.35           |
...
| VirtualServer With TLS profile       | [Example](./config_examples/customResource/VirtualServerWithTLSProfile)                                                             | VirtualServer with TLSProfile is used to specify the TLS termination. TLS termination relies on SNI                                                     | v2.1.0      |
| virtualServer insecure               | [Example](./config_examples/customResource/VirtualServer/unsecure-virtual-server)                                                   | Allows user to create a Virtual Server on BIG-IP with VIP. It will load balance the traffic for domain                                                  | v2.1.1      |
...
| virtualServer with waf               | [Example](./config_examples/customResource/VirtualServer/waf)                                                                       | By deploying this yaml file in your cluster, CIS will create a Virtual Server containing WAF policy on BIG-IP                                           | v2.2.0      |
| virtualServer Multiport Services     | [Example](./config_examples/customResource/VirtualServer/MultiPortServices)                                                         | Allows to configure multiple port definitions on a Service object                                                                                       | v2.2.0      |
...
| virtualServer with HostGroup         | [Example](./config_examples/customResource/VirtualServer/virtual-with-hostGroup)                                                    | Allows Associated VirutalServers are grouped based on “hostGroup” parameter. MultiHost support for VS CRD is achieved using this parameter              | v2.7.0      |
| virtualServer with Wildcard domain   | [Example](./config_examples/customResource/VirtualServer/virtual-with-wildcard-domain)                                              | Allows users to create a Virtual Server on BIG-IP with wildcard domain name                                                                             | v2.7.0      |
...
Refer Release Notes for [CIS v2.0](./RELEASE-NOTES.rst#20)
...
* Custom Resource Definition (CRD) -Alpha available with custom resource virtual-server. [CRD Doc and Examples](./config_examples/customResource/CustomResource.md).

### **Upgrading from 2.0 to 2.1:**

Refer Release Notes for [CIS v2.1](./RELEASE-NOTES.rst#21)
...
Refer Release Notes for [CIS v2.1.1](./RELEASE-NOTES.rst#211)
...
Refer Release Notes for [CIS v2.2.0](./RELEASE-NOTES.rst#220)
...
Refer Release Notes for [CIS v2.2.1](./RELEASE-NOTES.rst#221)
...
* CRD schema definition for [External DNS](https://raw.githubusercontent.com/F5Networks/k8s-bigip-ctlr/2.x-master/docs/config_examples/customResourceDefinitions/customresourcedefinitions.yml) and [examples](./config_examples/customResource/ExternalDNS).

### **Upgrading from 2.2.1 to 2.2.2:**

Refer Release Notes for [CIS v2.2.2](./RELEASE-NOTES.rst#222)
...
Refer Release Notes for [CIS v2.3.0](./RELEASE-NOTES.rst#230)
...
Refer Release Notes for [CIS v2.4.0](./RELEASE-NOTES.rst#240)
...
Refer Release Notes for [CIS v2.5.0](./RELEASE-NOTES.rst#250)
...
Refer Release Notes for [CIS v2.6.0](./RELEASE-NOTES.rst#260)

**_Functionality Changes:_**

* CIS supports IP address assignment to IngressLink Custom Resources using F5 IPAM Controller(See [documentation](./config_examples/customResource/IngressLink/ingressLink-with-ipamLabel))
...
Refer Release Notes for [CIS v2.6.1](./RELEASE-NOTES.rst#261)
...
Refer Release Notes for [CIS v2.7.0](./RELEASE-NOTES.rst#270)
...
Refer Release Notes for [CIS v2.7.1](./RELEASE-NOTES.rst#271)
...
Refer Release Notes for [CIS v2.8.0](./RELEASE-NOTES.rst#280)
...
Refer Release Notes for [CIS v2.9.0](./RELEASE-NOTES.rst)
...
* Setting TCP Profile in Policy CRD changed to support TCP Client and Server profiles. (See [documentation](./config_examples/customResource/Policy))
* Setting pool priority order in EDNS CRD requires a CRD schema update. (See [documentation](./config_examples/customResource/ExternalDNS))

### **Upgrading from 2.9.0 to 2.9.1:**

Refer Release Notes for [CIS v2.9.1](./RELEASE-NOTES.rst)

### **Upgrading from 2.9.1 to 2.10.0:**

Refer Release Notes for [CIS v2.10.0](./RELEASE-NOTES.rst)

### **Upgrading from 2.10.0 to 2.10.1:**

Refer Release Notes for [CIS v2.10.1](./RELEASE-NOTES.rst)
...
Refer Release Notes for [CIS v2.11.0](./RELEASE-NOTES.rst)

### **Upgrading from 2.11.0 to 2.11.1:**

Refer Release Notes for [CIS v2.11.1](./RELEASE-NOTES.rst)
...
* Refer [guide](./config_examples/next-gen-routes/migration-guide.md) to migrate to next generation routes.
...
* Upgrade the CRD schema using [CRD Update Guide](./config_examples/customResourceDefinitions/crd_update.md), if you are using custom resources.
...
* **_Configuration Change:_**
  * CIS extended to leverage server-side http2 profile on virtual Server which requires modification in the existing Policy CRD in case of using http2 functionality.
    * Please change the PolicyCRD accordingly with this [example](./config_examples/customResource/Policy/sample-policy.yaml)
...
Refer Release Notes for [CIS v2.13.1](./RELEASE-NOTES.rst)
...
Refer Release Notes for [CIS v2.15](./RELEASE-NOTES.rst)
...
Refer Release Notes for [CIS v2.15.1](./RELEASE-NOTES.rst)
...
Refer Release Notes for [CIS v2.16.0](./RELEASE-NOTES.rst)


### **Upgrading from 2.16.0 to 2.16.1:**

Refer Release Notes for [CIS v2.16.1](./RELEASE-NOTES.rst)


### **Upgrading from 2.16.1 to 2.17.0:**

Refer Release Notes for [CIS v2.17.0](./RELEASE-NOTES.rst)
