...
func NewAS3Manager(params *Params) *AS3Manager {
	...
	// Generate TOKEN
    // as3Manager.PostManager.TOKEN = as3Manager.PostManager.getBigipAuthToken(as3Manager.PostManager.BIGIPUsername, as3Manager.PostManager.BIGIPPassword)
...
func (am *AS3Manager) getADC() map[string]interface{} {
	...
	baseAS3ConfigTemplate := fmt.Sprintf(baseAS3Config, am.as3SchemaVersion)
...
func (am *AS3Manager) getEmptyAs3Declaration(partition string) as3Declaration {
	...
	baseAS3ConfigEmpty := fmt.Sprintf(baseAS3Config, am.as3SchemaVersion)
