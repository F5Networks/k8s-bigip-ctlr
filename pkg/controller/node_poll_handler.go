...
func (ctlr *Controller) processStaticRouteUpdate(
	...
	routes := routeSection{}
	routes.CISIdentifier = ctlr.Partition + "_" + strings.TrimPrefix(ctlr.RequestHandler.AgentWorkers[PrimaryBigIP].APIHandler.LTM.PostManager.BIGIPURL, "https://")
	...
	doneCh, errCh, err := ctlr.RequestHandler.AgentWorkers[PrimaryBigIP].ConfigWriter.SendSection("static-routes", routes)
