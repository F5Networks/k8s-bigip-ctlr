...
//			res.ltmConfig["virtualServer"] = &ResourceConfig{
//				Virtual: Virtual{
//					Name: "VirtualServer",
//				},
//			}
//
//			rsCfg, ok := res.getResource("virtualServer")
//			Expect(ok).To(BeTrue())
//			Expect(rsCfg.Virtual.Name).To(Equal("VirtualServer"))
//		})
//
//		It("Get all Resources", func() {
//			res.ltmConfig["virtualServer1"] = &ResourceConfig{
//				Virtual: Virtual{
//					Name: "VirtualServer1",
//				},
//			}
//			res.ltmConfig["virtualServer2"] = &ResourceConfig{
//				Virtual: Virtual{
//					Name: "VirtualServer2",
//				},
//			}
//
//			rsCfgs := res.GetLTMConfigCopy()
