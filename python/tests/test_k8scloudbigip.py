...
class KubernetesTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with patch.object(ManagementRoot, '_get_tmos_version'):
            ...
            self.cccl = ctlr.K8sCloudServiceManager(
                bigip,
                partition,
        ...
        self.cccl._bigip_proxy._bigip.tm = type('', (), {})()
        self.cccl._bigip_proxy._bigip.tm.net = type('', (), {})()
        self.cccl._bigip_proxy._bigip.tm.net.fdb = type('', (), {})()
        self.cccl._bigip_proxy._bigip.tm.net.fdb.tunnels = type('', (), {})()
        self.cccl._bigip_proxy._bigip.tm.net.fdb.tunnels.tunnel = \
            type('', (), {})()
        self.cccl._bigip_proxy._bigip.tm.net.fdb.tunnels.tunnel.load = \
    ...
    def verify_kubernetes_config(self, cloud_state, expected_state):
        ...
        cfg = ctlr.create_config_kubernetes(self.cccl, self.cloud_data)

        with open(expected_state) as json_data:
                exp = json.load(json_data)
        self.assertEqual(cfg, exp)

        self.cccl._apply_config(cfg)
    ...
    def test_cccl_exceptions(
        ...
        self.assertRaises(F5CcclValidationError, self.cccl._apply_config, cfg)
    ...
    def test_network_0_existing_vxlan_nodes_0_requested_vxlan_nodes(
        ...
        self.assertEqual(self.cccl._bigip_proxy._bigip.
